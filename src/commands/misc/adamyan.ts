...
export default class AdamyanCommand extends BaseCommand {
	...
	private async adamyan(): Promise<any> {
		...
		adamyanEmbed.setImage(
			"https://cdn.discordapp.com/attachments/1116797977432961197/1175905401464684715/image.png?ex=656cee3e&is=655a793e&hm=aa21cd0fc3ebd1f8ff2dc08ab3947dc5121178ef8c6cc12eb3eddaff21d3681b"
		);
