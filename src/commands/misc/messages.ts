...
export default class NevarCommand extends BaseCommand {
    ...
    private async geilerBot(): Promise<any> {
        ...
        const nevarEmbed: EmbedBuilder = this.client.createEmbed("Heute wurden bisher **{0} Nachrichten** von **{1} Menschen** geschrieben! Bisher ist <@{2}> der Aktivste! Danke für eure Aktivität <3", "arrow", "normal", count, writers, mostActiveUser);
