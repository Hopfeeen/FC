...
export default class EaCommand extends BaseCommand {
	...
	private async ea(): Promise<any> {
		...
		eaEmbed.setImage(
			"https://cdn.discordapp.com/attachments/1116797977432961197/1177681229068390460/image.png?ex=6573641d&is=6560ef1d&hm=da2b37ffd4b0f62291a8c72d788d10d15c858ceeae435d60a6497dec0bbaa8a8"
		);
