...
export default class KeeperCommand extends BaseCommand {
    ...
    private async keeper(): Promise<any> {
        ...
        keeperEmbed.setImage("https://cdn.discordapp.com/attachments/1116797977432961197/1177675326147539035/Bild_2023-11-24_191709869.png?ex=65735e9d&is=6560e99d&hm=a44f997404ef4af11faa72e25f3a974506499195e2a5b60d60498062987b3d53");
